...
from user_page.views import UserPage, UserChangePassword, UserChangeEmail, UserChangeNgrok, UserChangeImage, UserDelete
...
class TestUrls(SimpleTestCase):
    ...
    def test_list_resolve(self):
        ...
        self.assertEqual(
            resolve(url_change_email).func.view_class, UserChangeEmail)
        self.assertEqual(
            resolve(url_change_ngrok).func.view_class, UserChangeNgrok)
        self.assertEqual(
            resolve(url_change_image).func.view_class, UserChangeImage)
