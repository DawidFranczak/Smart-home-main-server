function add_sensor_button() {
    const as = document.querySelector('.add-sensor');
...
async function fadd_sensor() {
      ...
      if (dataRep["response"] == "Udało sie dodać czujnik") {
        ...
        switch (fun) {
          case "temp":
            ...
            document
              .getElementById("add_sensor_temp_container")
              .appendChild(div);
            break;
          case "sunblind":
            ...
            div.appendChild(input);
            document
              .getElementById("add_rolety_container")
              .appendChild(div);
            break;
          case "light":
            ...
            div.appendChild(input);
            document
              .getElementById("add_swiatlo_container")
              .appendChild(div);
            break;
          case "aqua":
            ...
            div.appendChild(input);
            document
              .getElementById("add_aqua_container")
              .appendChild(div);
            break;
          case "rfid":
            pFun.innerHTML = "RFID";
            ...
            div.appendChild(input);
            document
              .getElementById("add_rfid_container")
              .appendChild(div);
          ...
          case "btn":
              ...
              div.appendChild(input);
              document
                .getElementById("add_btn_container")
                .appendChild(div);
              break;
          case "lamp":
              ...
              div.appendChild(input);
              document
                .getElementById("add_lamp_container")
                .appendChild(div);
              break;
          case "stairs":
              ...
              div.appendChild(input);
              document
                .getElementById("add_stairs_container")
                .appendChild(div);
              break;
        }
    ...
    else {document.getElementById("response").innerHTML = "Brak nazwy";
  }
} 
  ...
  function showRfid(e){
    ...
    if(e.target.type == 'radio' && e.target.value =='uid') rfid.style.display = 'block';
    else if(e.target.type == 'radio' && e.target.value !='uid') rfid.style.display = 'none'
  }
